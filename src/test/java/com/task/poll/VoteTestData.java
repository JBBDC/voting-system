...
public class VoteTestData {
    ...
    public static Vote USER_VOTE_2 = new Vote(VOTE_1_ID + 1, USER, LocalDate.of(2020, 01, 13), REST_1);
    ...
    public static Vote getCreated() {
        return new Vote(VOTE_1_ID + 4, USER, LocalDate.now(), REST_1);
    }
    public static Vote getUpdated() {
        return new Vote(VOTE_1_ID + 4, ADMIN, LocalDate.now(), REST_2);
    }
