...
public class RestaurantTestData {
    ...
    public static Restaurant REST_1_ACTUAL_DISHES = new Restaurant(REST_1_ID, "First restaurant", List.of(DISH_1));
    public static Restaurant REST_1 = new Restaurant(REST_1_ID, "First restaurant", List.of(DISH_1, DISH_2, DISH_3));
    public static Restaurant REST_2_ACTUAL_DISHES = new Restaurant(REST_1_ID + 1, "Second restaurant", List.of(DISH_4, DISH_5));
    public static Restaurant REST_2 = new Restaurant(REST_1_ID + 1, "Second restaurant", List.of(DISH_4, DISH_5, DISH_6));
