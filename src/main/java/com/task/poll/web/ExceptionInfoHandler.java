...
import static com.task.poll.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    private String logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... details) {
        Throwable rootCause = ValidationUtil.logAndGetRootCause(log, req, e, logException, errorType);
        return ValidationUtil.getMessage(rootCause);
    }
